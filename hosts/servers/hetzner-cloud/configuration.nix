...

{
  ...
  # Basic packages
  # NOTE: Minimized for initial deployment to reduce closure size
  # Add more packages after successful deployment
  environment.systemPackages = with pkgs; [
    # htop
    # unzip
    # zip
    # openssh  # Already included by services.openssh.enable
    # gcc
    # gnumake
    # pkg-config
  ];
