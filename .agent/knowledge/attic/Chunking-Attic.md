Attic uses the [FastCDC algorithm](https://www.usenix.org/conference/atc16/technical-sessions/presentation/xia) to split uploaded NARs into chunks for deduplication. There are four main parameters that control chunking in Attic:
...
## [Configuration](https://docs.attic.rs/admin-guide/chunking.html#configuration)
...
[](https://docs.attic.rs/admin-guide/deployment/nixos.html "Previous chapter")[](https://docs.attic.rs/faqs.html "Next chapter")
