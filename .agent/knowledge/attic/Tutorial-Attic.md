...
## [Cache Creation](https://docs.attic.rs/tutorial.html#cache-creation)
...
## [Pushing](https://docs.attic.rs/tutorial.html#pushing)
...
## [Pulling](https://docs.attic.rs/tutorial.html#pulling)
...
## [Access Control](https://docs.attic.rs/tutorial.html#access-control)
...
Now Alice can use this token to _create_ any cache beginning with `alice-` and push to them. Try passing `--dump-claims` to show the JWT claims without encoding the token to see what's going on.

## [Going Public](https://docs.attic.rs/tutorial.html#going-public)
...
## [Garbage Collection](https://docs.attic.rs/tutorial.html#garbage-collection)
...
## [Summary](https://docs.attic.rs/tutorial.html#summary)
...
## [What's next](https://docs.attic.rs/tutorial.html#whats-next)
...
[](https://docs.attic.rs/introduction.html "Previous chapter")[](https://docs.attic.rs/user-guide/index.html "Next chapter")
